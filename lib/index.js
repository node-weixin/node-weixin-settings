...
module.exports = {
  ...
  // A sessionizable settings with get set, which returns a new settings object, but with req, res info
  // For customization on application level
  sessionizable: function _sessionizable() {
    return this;
  },
  all: function (id, cb) {
